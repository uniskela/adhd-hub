...
| `ADHD_HUB_AI_MODEL` | `llama3.2` | string | Model id passed to the provider. Gemini OpenAI-compat list ids may include a `models/` prefix; Hub strips that for chat and when filling the Model dropdown (use bare ids like `gemini-2.5-flash`). |
