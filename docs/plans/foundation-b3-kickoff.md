...
This plan **started** the B3 product train. B3 shipped in full via [#152](https://github.com/uniskela/adhd-hub/pull/152) (closes [#75](https://github.com/uniskela/adhd-hub/issues/75)). Wave 6 [#52](https://github.com/uniskela/adhd-hub/issues/52) shipped on `main` for v0.16.0. Current product train is Wave 7 [#54](https://github.com/uniskela/adhd-hub/issues/54). Keep [#117](https://github.com/uniskela/adhd-hub/issues/117) deferred and separate.
...
- Public sequence: B3 #75 ✅ → Wave 6 #52 ✅ → **NOW = Wave 7** [#54](https://github.com/uniskela/adhd-hub/issues/54) → 8 [#55](https://github.com/uniskela/adhd-hub/issues/55). See [improvement-roadmap.md](improvement-roadmap.md).
